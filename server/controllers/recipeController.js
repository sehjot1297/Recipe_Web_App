...
//     try {
//         const res = await Recipe.deleteOne( { name: 'abc' });
//         console.log(res.n); 
...
async function updateRecipe(){
    try {
        const res = await Recipe.updateOne({ name: 'abc' }, { name: 'xyz' });
        console.log(res.n); 
        console.log(res.nModified);
    } catch (error) {
        console.log(error);
...
//                 "description": `A great Friday night recipe to share with friends by Maddie Rix from Jamie's food team.`,
...
//   ],
//                 "category": "Mexican",
//                 "image": "Mexican-marinated-pork-tenderloin.webp"
//               }
//               ]
//         );
//     }catch(error){
...
//                 "description": `Paneer Butter Masala (Paneer Makhani) Recipe with Step by Step Pictures. Popular restaurant style paneer butter masala made easily at home. Creamy and flavourful butter paneer is so easy to make at home. You can serve it with naan, roti, pulao or jeera pulao.`,
//                 "email": "hello@email.com",
//                 "ingredients": [
...
//                 "description": `Wash the mussels thoroughly, discarding any that aren’t tightly closed. Trim and finely slice the spring onions, peel and finely slice the garlic. Pick and set aside the coriander leaves, then finely chop the stalks. Cut the lemongrass into 4 pieces, then finely slice the chilli.\n        In a wide saucepan, heat a little groundnut oil and soften the spring onion, garlic, coriander stalks, lemongrass and most of the red chilli for around 5 minutes.\n        \n        
